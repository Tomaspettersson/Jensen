...
<main class="jumbotron">
    ...
    <div>
        <h2>Snabbaste vägen till jobb</h2>
        <p>
            ...
            Saknar du behörighet till en Yh-utbildning? I så fall kan du läsa en eller flera preparandkurser på distans, så att du får den behörighet du behöver.
        </p>
        <img src="images/ITprojektledare%20(1).jpg">
    </div>
